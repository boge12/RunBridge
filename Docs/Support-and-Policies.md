...
- **Support email:** [support@runbridge.dev](mailto:support@runbridge.dev)  
- **General questions:** [hello@runbridge.dev](mailto:hello@runbridge.dev)

When you email support, it helps a lot if you include:
...
- Always use caution when running on a treadmill.
- Keep cables and the device positioned so they won’t interfere with your stride or cause tripping.
- Do not use damaged cables, ports, or power supplies.

RunBridge is **not** affiliated with or endorsed by Garmin, Assault, or any treadmill manufacturer. All trademarks are property of their respective owners.

By using this device, you accept that:

- Indoor running and treadmill use carry inherent risks.
- The creator of RunBridge is not liable for injuries or damages resulting from use or misuse of the device.

If anything in this page is unclear, feel free to ask at  
